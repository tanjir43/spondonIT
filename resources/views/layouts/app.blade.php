  ...
  <body>
    ...
    <footer class="footer pt-5" style="background-color:#cdebcb ">
      <div class="container pb-2">
          ...
          <div class="col-md-6 col-xl-5">
            ...
            <div class="row">
              <div class="col-sm-6 mb-6">
                <h3 class="h6 mb-2 pb-1 fs-base text-dark">SPONDON IT</h3>
                <p class="text-justify" style=" text-align: justify;text-justify: inter-word;">We specialize in converting your Vision about your website into Reality. Welcome to <span class="text-primary">SPONDON IT</span>, a specialist web design and development agency based in Bangladesh.</p>
              </div>
              <div class="col-sm-6 mb-6">
        ...
        <!-- Copyright-->
        <p class="fs-sm text-center text-sm-start mb-4"><span class="text-dark opacity-50">&copy; All rights reserved. Made by </span><a class="nav-link-dark fw-bold" href="https://www.spondonit.com.bd/" target="_blank" rel="noopener">SPONDON IT</a></p>
      </div>
    </footer>
